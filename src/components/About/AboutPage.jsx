      ...
      <div className="core-values">
        ...
        <div className="paragraph-container story-p">
          ...
          <p>
            ...
            of our enterprise, dedicated 28 years of his life to mastering the
            art of landscaping under the guidance of Kauai&apos;s most revered
            landscapers, Abby and Frank Santos of No Ka Oi Plants. His tenure
            with them was more than a job; it was a lifelong apprenticeship that
            honed his skills, ethic, and passion for the craft. When Abby and
            Frank decided to retire, it wasn&apos;t just the end of an era but
            the dawn of a new beginning for us. Motivated by a shared dream and
            our combined strengths, Kainoa and I, Mele Huddy, embarked on this
            entrepreneurial journey. With his unparalleled expertise and my
            drive to build a legacy of greatness, Huddy Landscape Service, Inc.
            was born—a family business that prides itself on delivering
            exceptional landscape solutions with a touch of Hawaiian spirit.
          </p>
        </div>
        <img
        ...
        <div className="paragraph-container vision-p">
          ...
          <p>
            ...
            create outdoor environments that reflect the beauty and resilience
            of Kauai, offering a sanctuary for growth, peace, and joy. As a
            Hawaiian and woman-owned enterprise, we carry forward the legacy of
            those who nurtured us, channeling our skills and passion into every
        ...
        <div className="paragraph-container commitment-p">
          ...
          <p>
            ...
            techniques with modern, eco-friendly practices, ensuring that our
            work not only enhances the aesthetic appeal of your space but also
            ...
            blending colors, textures, and fragrances that thrive in
            Kauai&apos;s unique climate, creating breathtaking landscapes that
